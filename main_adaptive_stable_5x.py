"""
Gate.io Futures Trading Bot - V1 Adaptive Strategy (안정 운용)

전략: V1 Adaptive (ADX 25+)
레버리지: 5x (균형)
백테스트 결과 (60일): 평균 ROI +16.93%
